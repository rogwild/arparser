            ...
            <section id="content">
                ...
                <div class="page page-shop-single-product">
                    ...
                    <div class="pageheader">
                        ...
                        <h2>Создать слова для множественного удаления<span>  </span></h2>
                    ...
                    <div class="pagecontent">
                        ...
                        <div class="add-nav">
                            <div class="nav-heading">
                                <h3>Создать<strong class="text-greensea"> слова для удаления</strong></h3>
                                <span class="controls pull-right">
                                  <a href="{{ route('extrawords.table', $shop->id) }}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Назад"><i class="fa fa-times"></i></a>
                                </span>
                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <section class="tile">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <form method='POST' class="form-horizontal ng-pristine ng-valid" role="form" action='{{ action('ExtraWordsController@store', $shop->id) }}'>
                                                            {{ csrf_field() }}
                                                            
                                                            <div class="form-group">
                                                                <label for="title" class="col-sm-2 control-label">Название: <span class="text-lightred text-md">*</span></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="title" name="title" placeholder="Название для магазина">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control" rows="5" name="body" id="body" placeholder="Write something about you...">
                                                                    </textarea>
                                                                </div>
                                                            </div>
