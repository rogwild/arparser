                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="shop-single-product.html">{{ $car->title }}</a>
                                </li>
                            </ul>
                    ...
                    <div class="pagecontent">
                        ...
                        <div class="add-nav">
                            <div class="nav-heading">
                                <h3>Номер: <strong class="text-greensea">{{ $car->id }}</strong></h3>
                                <span class="controls pull-right">
                                  <a href="{{ route('cars.table') }}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Назад"><i class="fa fa-times"></i></a>
                                </span>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4" data-lightbox="gallery">
                                                                ...
                                                                <a href="#" class="img-link" data-lightbox="gallery-item">
                                                                    <img src="#" alt="" class="img-responsive mb-20">
                                                                </a>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <section class="tile">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <form method='POST' class="form-horizontal ng-pristine ng-valid" role="form" action='{{ action('ParserController@CarTranslate', $car->id) }}'>
                                                            {{ csrf_field() }}

                                                            <div class="form-group">
                                                                <label for="id" class="col-sm-2 control-label">ID: </label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="id" placeholder="Item ID" value="{{ $car->id }}" disabled="">
                                                                </div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="translate" class="col-sm-2 control-label">{{ $car->title }}: <span class="text-lightred text-md">*</span></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="translate" name="translate" placeholder="Item Name" value="{{ $car->translate }}">
                                                                </div>
                                                            </div>
