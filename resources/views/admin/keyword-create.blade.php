            ...
            <section id="content">
                ...
                <div class="page page-shop-single-product">
                    ...
                    <div class="pageheader">
                        ...
                        <h2>Создать ключевые слова<span>  </span></h2>
                    ...
                    <div class="pagecontent">
                        ...
                        <div class="add-nav">
                            <div class="nav-heading">
                                <h3>Создать<strong class="text-greensea">ключевое слово</strong></h3>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <section class="tile">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <form method='POST' class="form-horizontal ng-pristine ng-valid" role="form" action='{{ action('KeywordController@KeywordCreate') }}'>
                                                            {{ csrf_field() }}
                                                            
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-2 control-label">Название: <span class="text-lightred text-md">*</span></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Название для ключевых слов">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="words" name="words" placeholder="Ключевые слова через запятую или предложение">
                                                                </div>
                                                            </div>
