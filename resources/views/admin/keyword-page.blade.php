                    ...
                    <div class="pagecontent">
                        ...
                        <div class="add-nav">
                            <div class="nav-heading">
                                <h3>Номер: <strong class="text-greensea">{{ $keyword->id }}</strong></h3>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <section class="tile">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <form method='POST' class="form-horizontal ng-pristine ng-valid" role="form" action='{{ action('KeywordController@KeywordEdit', $keyword->id) }}'>
                                                            {{ csrf_field() }}

                                                            <div class="form-group">
                                                                <label for="id" class="col-sm-2 control-label">ID: </label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="id" placeholder="Item ID" value="{{ $keyword->id }}" disabled="">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="name" name="newName" placeholder="Название для ключевых слов" value="{{ $keyword->name }}">
                                                                </div>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="words" class="col-sm-2 control-label">Слова: <span class="text-lightred text-md">*</span></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="words" name="newWords" placeholder="Ключевые слова через запятую или предложение" value="{{ $keyword->words }}">
                                                                </div>
                                                            </div>
