                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile">
                                    ...
                                    <div class="tile-header dvd dvd-btm">
                                        <h1 class="custom-font"><strong>Магазины</strong></h1>
                                        <ul class="controls">
                                            <li><a href="{{ route('shop.create.page') }}"><i class="fa fa-plus mr-5"></i> Новый магазин</a></li>
                                            <li class="dropdown">
                                            ...
                                            <table class="table table-striped table-hover table-custom" id="products-list">
											  ...
											  @foreach ($shops as $shop)
												<tr>
												  ...
												  <td><img src="{{ $shop->image }}" alt="" class="img-thumbnail" style="width:50px;"></td>
												  <td>
													  <a href="{{ route('shop.page',[$shop->id]) }}">
														  <small>
															{{ $shop->name }}
														  </small>
													  </a>
