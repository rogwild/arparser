                    ...
                    <div class="pagecontent">
                        ...
                        <div class="add-nav">
                            <div class="nav-heading">
                                <h3>Создать<strong class="text-greensea"> новый товар</strong></h3>
                                <span class="controls pull-right">
                                  <a href="{{ route('keywords.table') }}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Назад"><i class="fa fa-times"></i></a>
                                </span>
                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <section class="tile">
                                                    ...
                                                    <div class="tile-header dvd dvd-btm">
                                                        <h1 class="custom-font"><strong>Введите данные</strong> </h1>
                                                    </div>
                                                    <!-- /tile header -->
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <form method='POST' class="form-horizontal ng-pristine ng-valid" role="form" action='{{ action('ProductController@ProductCreate', $shop->id) }}' enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="models" name="models" placeholder="Автомобили через запятую: Toyota Crown, Toyota Chaser">
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="form-group">
                                                                <label for="price" class="col-sm-2 control-label">Цена: <span class="text-lightred text-md"></span></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" id="price" class="form-control touchspin" data-min='0' data-max="100000" data-step="0.1" data-decimals="0" name="price" data-stepinterval="50" data-maxboostedstep="100000" data-prefix="РУБЛЕЙ">
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="row">
                                                            	<div class="col-sm-offset-4 col-sm-4 text-center">
																	<button type="submit" class="btn btn-ef btn-ef-1 btn-ef-1-success btn-ef-1b mb-10">Создать</button>
																</div>
                                                            </div>
